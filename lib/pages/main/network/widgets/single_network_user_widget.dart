...
import 'package:flutter_linkedin_clone/data/network_entity.dart';
          ...
          Align(
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                  color: linkedInLightGreyCACCCE, shape: BoxShape.circle),
              child: ClipRRect(
                borderRadius: BorderRadius.circular(60),
                child: Image.asset("assets/${widget.network.userProfileImage}"),
              ),
            ),
          ),
        ],
